...
namespace LT {
    Queue::Queue(const uint64 in_count, const uint64 elementSize) : Array(in_count, elementSize),
        last_element_index(0), first_element_index(0), isEmpty(true)
    {}
    ...
    void* Queue::Pop() {
        ...
        if (!isEmpty) {
            first_element_index++;
            first_element_index = first_element_index > elements_count
                ? 0
                : first_element_index;
        }
        return element;
    ...
    void Queue::Push(void* element) {
        ...
        last_element_index = last_element_index > elements_count ?
